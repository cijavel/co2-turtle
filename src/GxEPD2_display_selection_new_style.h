...
#else
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ EPD_CS, /*DC=TX2*/ 17, /*RST=*/ -1, /*BUSY=*/ -1)); // my suggested wiring and proto board
